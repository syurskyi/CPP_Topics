...
in. main
    st. ve..<in.> v{1, 2, 3}sy.. pause

    // итератор на первое совпадение по значению или end()
    a.. one_it _ st. find(v.begin(), v.end(), 1)sy.. pause
