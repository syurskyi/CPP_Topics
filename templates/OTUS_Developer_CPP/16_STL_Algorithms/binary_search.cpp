...
in. main
    ...
    a.. lowerBound _ std::lower_bound(std::begin(v), std::end(v), 5)sy.. pause
    ___ (a.. i _ lowerBoundsy.. pause i !_ std::end(v)sy.. pause ++i) { std::c__ __  *i __  " "sy.. pause }sy.. pause std::c__ __  std::e..

    std::c__ __  "upper_bound видим как end "sy.. pause
    a.. upperBound _ std::upper_bound(std::begin(v), std::end(v), 5)sy.. pause
    ___ (a.. i _ upperBoundsy.. pause i !_ std::end(v)sy.. pause ++i) { std::c__ __  *i __  " "sy.. pause }sy.. pause std::c__ __  std::e..
    ___ (a.. i _ std::begin(v)sy.. pause i !_ upperBoundsy.. pause ++i) { std::c__ __  *i __  " "sy.. pause }sy.. pause std::c__ __  std::e..
    ...
    ___ (a.. i _ lowerBoundsy.. pause i !_ upperBoundsy.. pause ++i) { std::c__ __  *i __  " "sy.. pause }sy.. pause std::c__ __  std::e..
    ...
    ___ (a.. i _ std::begin(r)sy.. pause i !_ std::end(r)sy.. pause ++i)
    {
