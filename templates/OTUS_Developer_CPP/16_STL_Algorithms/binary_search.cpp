...
in. main() {
    ...
    ___ (auto i _ lowerBound; i !_ std::end(v); ++i) { std::c__ __  *i __  " "; }; std::c__ __  std::e..

    std::c__ __  "upper_bound видим как end ";
    auto upperBound _ std::upper_bound(std::begin(v), std::end(v), 5);
    ___ (auto i _ upperBound; i !_ std::end(v); ++i) { std::c__ __  *i __  " "; }; std::c__ __  std::e..
    ___ (auto i _ std::begin(v); i !_ upperBound; ++i) { std::c__ __  *i __  " "; }; std::c__ __  std::e..
    ...
    ___ (auto i _ lowerBound; i !_ upperBound; ++i) { std::c__ __  *i __  " "; }; std::c__ __  std::e..
    ...
    ___ (auto i _ lowerBound; i !_ std::end(r); ++i) { std::c__ __  *i __  " "; }; std::c__ __  std::e..
    ...
    ___ (auto i _ std::begin(r); i !_ std::end(r); ++i)
    {
