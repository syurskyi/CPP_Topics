...
in. main()
{
	...
	in. arr[4] _ { 10, 20, 30, 40 }sy.. pause
	...
	c__ __  "The size of first element of array = " __  s_o_(arr[0]) __  e..
	// расчитываем количество элементов массива
	c__ __  "Array length = " __  s_o_(arr) / s_o_(arr[0]) __  " element(s)." __  e..

	c__ __  "-------------------------------------------------------------------------------------" __  e..

	const in. size _ 10sy.. pause

	in. arr1[size]sy.. pause
