...
{
	c..* args1[] _ { "", "3", "+", "4" }sy.. p..
	tcOperation lcOp1( 4, args1 )sy.. p..
	EXPECT_DOUBLE_EQ( 7, lcOp1.Execute() )sy.. p..

	c..* args2[] _ { "", "9", "+", "10" }sy.. p..
	tcOperation lcOp2( 4, args2 )sy.. p..
	EXPECT_DOUBLE_EQ( 19, lcOp2.Execute() )sy.. p..

	c..* args3[] _ { "", "9.5", "+", "10.1" }sy.. p..
	tcOperation lcOp3( 4, args3 )sy.. p..
	EXPECT_DOUBLE_EQ( 19.6, lcOp3.Execute() )sy.. p..

	c..* args4[] _ { "", "9.57", "+", "10.12" }sy.. p..
	tcOperation lcOp4( 4, args4 )sy.. p..
	EXPECT_DOUBLE_EQ( 19.69, lcOp4.Execute() )sy.. p..
}
...
TEST( tcOperation, Subtract )
{
	c..* args1[] _ { "", "3", "-", "4" }sy.. p..
	tcOperation lcOp1( 4, args1 )sy.. p..
	EXPECT_DOUBLE_EQ( -1, lcOp1.Execute() )sy.. p..

	c..* args2[] _ { "", "19", "-", "10" }sy.. p..
	tcOperation lcOp2( 4, args2 )sy.. p..
	EXPECT_DOUBLE_EQ( 9, lcOp2.Execute() )sy.. p..

	c..* args3[] _ { "", "19.5", "-", "10.1" }sy.. p..
	tcOperation lcOp3( 4, args3 )sy.. p..
	EXPECT_DOUBLE_EQ( 9.4, lcOp3.Execute() )sy.. p..

	c..* args4[] _ { "", "29.57", "-", "10.12" }sy.. p..
	tcOperation lcOp4( 4, args4 )sy.. p..
	EXPECT_DOUBLE_EQ( 19.45, lcOp4.Execute() )sy.. p..
}
