...
main()
{
    ...
    sh.. t1 _ 5sy.. pause //-32768 to 32767, 2 BYTES

    c__ __  t1 __  e..

    float t2 _ 5.12sy.. pause //4 BYTES nr that are up to 38 zeros
    d.. t3 _ 5.12sy.. pause //8 BYTES nr that are up to 308 zeros 5.61235123512351

    c__ __  t2 __  e..
    c__ __  t3 __  e..

    c.. t4sy.. pause //character

    t4 _ 'a'sy.. pause
    c__ __  t4 __  e..

    s.. t5 _ "Hello World! :-)"sy.. pause

    c__ __  t5 __  e..

    s.. x _ "part1"sy.. pause
    s.. y _ "part2"sy.. pause
    s.. combinedStrings _ x + " " + ysy.. pause
